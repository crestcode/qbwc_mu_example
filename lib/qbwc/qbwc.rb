...
module QBWC
  ...
  class << self
    ...
    def api=(api)
      Rails.logger.debug "+++++++ API API API +++++++"
...
require 'soap_wrapper/default'
require 'soap_wrapper/defaultMappingRegistry'
require 'soap_wrapper/defaultServant'
require 'soap_wrapper/QBWebConnectorSvc'
require 'soap_wrapper'
require 'session'
require 'request'
require 'job'
